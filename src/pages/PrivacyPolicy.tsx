  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      ...
      <ul className="list-disc list-inside space-y-1">
        ...
        <li>Communicate with you about updates, support, or announcements.</li>
      </ul>
      ...
      <p>If you have questions about this policy, email us at <a className="text-blue-600 underline" href="mailto:stevenedwardobillemontalvo@gmail.com">stevenedwardobillemontalvo@gmail.com</a>.</p>
    </div>
  );
};
